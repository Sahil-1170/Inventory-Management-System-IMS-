...
export default function Hero() {
    ...
    return (
        <div className="bg-gradient-to-b from-red-800 flex flex-col py-8 md:py-32 px-4 md:px-16 text-slate-50 items-center gap-6">
            <div className="flex flex-col space-y-8 items-center max-w-4xl mx-auto text-center">
                ...
                <p className="text-base md:text-xl">
                    Increase Your Sales and keep track of every unit with
                    our powerful stock management, order fulfillment, and
